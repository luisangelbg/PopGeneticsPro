# Servidor web local minimo para PopGeneticsPro.
# Uso:  clic derecho > "Ejecutar con PowerShell"
#       (o:  powershell -ExecutionPolicy Bypass -File server.ps1)
# Luego abre  http://localhost:9000  en el navegador.
#
# PopGeneticsPro calcula todo en JavaScript, asi que el doble clic en index.html tambien
...
# direccion (algo como http://192.168.1.23:9000) para escribirla en el
...
Write-Host ""
Write-Host "  PopGeneticsPro en marcha:  $prefix" -ForegroundColor Green
if ($lan) {
